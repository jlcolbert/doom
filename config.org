...
- [[#documents][Documents]]
  ...
  - [[#autoloads][Autoloads]]
    ...
    - [[#zetteldesk-remarkel][=zetteldesk-remark.el=]]
...
** Org-remark
#+begin_src elisp :tangle no :noweb-ref p-org-remark
(package! org-remark)
#+end_src

#+begin_src elisp :tangle no :noweb-ref org-remark
...
#+begin_src elisp :tangle autoload/zetteldesk-remark.el
;;; autoload/zetteldesk-remark.el -*- lexical-binding: t; -*-
